  document.querySelector(".button").addEventListener("click", function() {
    ...
    switch (c) {
      case 'f':
        ...
        show();
        function show() {
          document.querySelector(".box").style.paddingRight="20%";
          document.querySelector(".form").style.paddingTop="150px";
      ...
      function show6() {
        ...
        document.querySelectorAll("h1")[1].style.fontSize="40px";
        document.querySelector(".output").style.lineHeight="40px";
